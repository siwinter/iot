...
//		Serial.print("mqtt : received : length "); Serial.println(l);
//		Serial.print("   topic: "); Serial.println(t);
//		Serial.print("   date:  "); Serial.println(c);
		if((strlen(t) < cNamLen) && (l < cInfoLen)) {
			strcpy(msg->name, t) ;
			strncpy(msg->info, c, l) ;
			msg->info[l]=0;
